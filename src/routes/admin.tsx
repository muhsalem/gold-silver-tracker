...
import { clearOverrides, readOverrides, writeOverrides } from "@/lib/overrides";
  ...
  return <Page eyebrow="إدارة القيَم" title={t("admin.title")} sub={t("admin.sub")}>
    ...
    {data && <div className="grid gap-6 lg:grid-cols-[1.25fr_.75fr]">
      ...
      <aside className="bg-primary p-6 text-primary-foreground sm:p-8">
        <p className="text-sm opacity-70">النتيجة الحالية بعد التعديل</p>
    ...
    <p className="mt-5 text-xs leading-6 text-muted-foreground">تُحفظ هذه القيم على هذا الجهاز فقط. ويظهر السعر اليدوي كنقطة اليوم في الرسم التاريخي للمقارنة مع سجل السوق.</p>
  </Page>;
}